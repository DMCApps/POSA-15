...
public class DownloadImagesBoundService 
	...
	public void handleMessage(Message message) {
	    ...
	    Log.i("DownloadImageBoundService", "Received download Url " + imageURL);
	    Log.i("DownloadImageBoundService", "Downloading to path " + directoryPathName);
		...
		new Runnable() {
			...
			// TODO -- you fill in here.
		    Uri pathToImageFile = NetUtils.downloadImage(mService.get().getApplicationContext(), imageURL, directoryPathName);
		    
		    Log.i("DownloadImagesBoundService", "Saved image to " + pathToImageFile);
